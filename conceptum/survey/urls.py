...
urlpatterns = patterns('',
    ...
    url(r'^finalize/$', views.FinalizeView.as_view(), name = 'finalize_view'),
    url(r'^finalize/finalize/$', views.finalize_survey, name = 'finalize_survey'),
    url(r'^final/$', views.FinalView.as_view(), name = 'final_survey'),
