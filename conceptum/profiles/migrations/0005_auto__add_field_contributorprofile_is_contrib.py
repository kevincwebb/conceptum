...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContributorProfile.is_contrib'
        db.add_column(u'profiles_contributorprofile', 'is_contrib',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContributorProfile.is_contrib'
        db.delete_column(u'profiles_contributorprofile', 'is_contrib')
