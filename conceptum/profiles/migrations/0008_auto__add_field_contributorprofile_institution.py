...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContributorProfile.institution'
        db.add_column(u'profiles_contributorprofile', 'institution',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContributorProfile.institution'
        db.delete_column(u'profiles_contributorprofile', 'institution')
