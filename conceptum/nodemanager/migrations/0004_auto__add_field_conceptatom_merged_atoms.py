...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConceptAtom.merged_atoms'
        db.add_column(u'nodemanager_conceptatom', 'merged_atoms',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nodemanager.ConceptAtom'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConceptAtom.merged_atoms'
        db.delete_column(u'nodemanager_conceptatom', 'merged_atoms_id')
    ...
    models = {
        ...
        u'nodemanager.conceptatom': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'merged_atoms': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nodemanager.ConceptAtom']", 'null': 'True'}),
