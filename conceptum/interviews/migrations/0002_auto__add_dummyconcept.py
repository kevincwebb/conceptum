...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DummyConcept'
        db.create_table(u'interviews_dummyconcept', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=31)),
        ))
        db.send_create_signal(u'interviews', ['DummyConcept'])


    def backwards(self, orm):
        # Deleting model 'DummyConcept'
        db.delete_table(u'interviews_dummyconcept')
