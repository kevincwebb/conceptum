...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interview.date_uploaded'
        db.add_column(u'interviews_interview', 'date_uploaded',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 7, 14, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interview.date_uploaded'
        db.delete_column(u'interviews_interview', 'date_uploaded')
