...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InterviewGroup'
        db.create_table(u'interviews_interviewgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('unlocked', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'interviews', ['InterviewGroup'])

        # Adding field 'Interview.group'
        db.add_column(u'interviews_interview', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['interviews.InterviewGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InterviewGroup'
        db.delete_table(u'interviews_interviewgroup')

        # Deleting field 'Interview.group'
        db.delete_column(u'interviews_interview', 'group_id')
