...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Excerpt.topic_id'
        db.delete_column(u'interviews_excerpt', 'topic_id')

        # Adding field 'Excerpt.object_id'
        db.add_column(u'interviews_excerpt', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Excerpt.topic_id'
        db.add_column(u'interviews_excerpt', 'topic_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Excerpt.object_id'
        db.delete_column(u'interviews_excerpt', 'object_id')
