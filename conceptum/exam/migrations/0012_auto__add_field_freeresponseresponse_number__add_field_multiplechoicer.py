...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FreeResponseResponse.number'
        db.add_column(u'exam_freeresponseresponse', 'number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MultipleChoiceResponse.number'
        db.add_column(u'exam_multiplechoiceresponse', 'number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FreeResponseResponse.number'
        db.delete_column(u'exam_freeresponseresponse', 'number')

        # Deleting field 'MultipleChoiceResponse.number'
        db.delete_column(u'exam_multiplechoiceresponse', 'number')
