...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MultipleChoiceOption.index'
        db.add_column(u'exam_multiplechoiceoption', 'index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MultipleChoiceOption.is_correct'
        db.add_column(u'exam_multiplechoiceoption', 'is_correct',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MultipleChoiceQuestion.number'
        db.add_column(u'exam_multiplechoicequestion', 'number',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'FreeResponseQuestion.number'
        db.add_column(u'exam_freeresponsequestion', 'number',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MultipleChoiceOption.index'
        db.delete_column(u'exam_multiplechoiceoption', 'index')

        # Deleting field 'MultipleChoiceOption.is_correct'
        db.delete_column(u'exam_multiplechoiceoption', 'is_correct')

        # Deleting field 'MultipleChoiceQuestion.number'
        db.delete_column(u'exam_multiplechoicequestion', 'number')

        # Deleting field 'FreeResponseQuestion.number'
        db.delete_column(u'exam_freeresponsequestion', 'number')
