...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResponseSet.exam'
        db.add_column(u'exam_responseset', 'exam',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exam.Exam']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResponseSet.exam'
        db.delete_column(u'exam_responseset', 'exam_id')
