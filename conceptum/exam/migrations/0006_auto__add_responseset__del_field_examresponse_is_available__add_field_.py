...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'exam_responseset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('instructor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.ContributorProfile'])),
            ('course', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('pre_test', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'exam', ['ResponseSet'])

        # Deleting field 'ExamResponse.is_available'
        db.delete_column(u'exam_examresponse', 'is_available')

        # Adding field 'ExamResponse.submitted'
        db.add_column(u'exam_examresponse', 'submitted',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'exam_responseset')

        # Adding field 'ExamResponse.is_available'
        db.add_column(u'exam_examresponse', 'is_available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'ExamResponse.submitted'
        db.delete_column(u'exam_examresponse', 'submitted')
    ...
    models = {
        ...
        u'exam.examresponse': {
            ...
            'submitted': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'})
        },
