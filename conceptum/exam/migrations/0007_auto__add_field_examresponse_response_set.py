...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExamResponse.response_set'
        db.add_column(u'exam_examresponse', 'response_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['exam.ResponseSet']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExamResponse.response_set'
        db.delete_column(u'exam_examresponse', 'response_set_id')
