...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exam.kind'
        db.add_column(u'exam_exam', 'kind',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Exam.stage'
        db.add_column(u'exam_exam', 'stage',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exam.kind'
        db.delete_column(u'exam_exam', 'kind')

        # Deleting field 'Exam.stage'
        db.delete_column(u'exam_exam', 'stage')
