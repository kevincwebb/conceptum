...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExamResponse.id'
        db.delete_column(u'exam_examresponse', u'id')
        ...
        # Changing field 'ExamResponse.key'
        db.alter_column(u'exam_examresponse', 'key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64, primary_key=True))
        ...
        # Changing field 'MultipleChoiceResponse.option'
        db.alter_column(u'exam_multiplechoiceresponse', 'option_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exam.MultipleChoiceOption'], null=True))

    def backwards(self, orm):
        # Adding field 'ExamResponse.id'
        db.add_column(u'exam_examresponse', u'id',
        ...
        # Changing field 'ExamResponse.key'
        db.alter_column(u'exam_examresponse', 'key', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True))

        # Changing field 'MultipleChoiceOption.question'
        db.alter_column(u'exam_multiplechoiceoption', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exam.FreeResponseQuestion']))

        # Changing field 'MultipleChoiceResponse.option'
        db.alter_column(u'exam_multiplechoiceresponse', 'option_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exam.MultipleChoiceOption']))
    ...
    models = {
        ...
        u'exam.examresponse': {
            ...
            'expiration_days': ('django.db.models.fields.IntegerField', [], {'default': '7'}),
